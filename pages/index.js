...
export default function Home() {
  ...
  return (
    <div className='flex justify-center'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4' style={{height:'auto'}}>
            {
              nfts.map((nft, i)=>(
                <div key={i} className='border shadow rounded-x1 overflow-hidden'>
                  <img src={nft.image} className='h-2/4' style={{width:"100%",objectFit:'cover'}} />
                  <div className='p-4' >
